...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (GridView1.SelectedRow.Cells[6].Text.ToString() != "")
        {
            try
            {
                TextBox3.Text = Convert.ToDateTime(GridView1.SelectedRow.Cells[6].Text).ToShortDateString();
            }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else if (Button1.Text == "Update")
        {
           ...
           Boolean sql = DAO.update(TextBox1.Text,TextBox2.Text,TextBox3.Text,DropDownList1.SelectedValue.ToString());
            if (sql)
            {
                Response.Redirect("admin_Payment.aspx");
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            Boolean sql = DAO.del(TextBox1.Text);
            if (sql)
            {
                Response.Redirect("admin_Payment.aspx");
                GridView1.EditIndex = -1;
    ...
    {
        Response.Redirect("admin_Payment.aspx?searchkey=" + txtSearch.Text.Trim());
    }
}